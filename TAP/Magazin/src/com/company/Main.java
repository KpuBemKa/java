...
//        alimente.sort((Aliment a1, Aliment a2) ->{
//            return a1.calorii - a2.calorii;
//        });
        alimente.sort(Comparator.comparingInt((Aliment a) -> a.calorii));
        jucarii.sort(Comparator.comparingInt((Jucarie a) -> a.varstaMinima));

//        calculatoare.sort((Calculator c1, Calculator c2) ->{
//            return c1.producator.compareTo(c2.producator);
//        });
