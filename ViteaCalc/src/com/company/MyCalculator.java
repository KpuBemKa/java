...
////////////////////////////////////////  
    ...
    public static void main(String[] args) {
        new MyCalculator("Lucrare Individuala Nr.1 - Calculator");
    }
}
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (opText.equals("1/X")) {
            try {
                ...
                cl.displayLabel.setText("Imparte cu 0.");
            }
            return;
        }
...
//Verifica butonul C si dupa il reseteaza
        if (opText.equals("C")) {
            cl.number = 0.0;
            cl.op = ' ';
            cl.memValue = 0.0;
